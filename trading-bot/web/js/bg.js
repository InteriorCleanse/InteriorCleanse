...
try {
  ...
  if (cv && cv.getContext) {
    ...
    const ORBS = [
      { x: 0.16, y: 0.12, c: '52,211,153',  r: 0.62, ax: 0.06, ay: 0.05, sx: 0.021, sy: 0.017, ph: 0.0, a: 0.10 },
      { x: 0.84, y: 0.20, c: '163,230,53',  r: 0.54, ax: 0.07, ay: 0.05, sx: 0.017, sy: 0.023, ph: 1.7, a: 0.08 },
      { x: 0.74, y: 0.82, c: '34,211,238',  r: 0.60, ax: 0.06, ay: 0.06, sx: 0.019, sy: 0.015, ph: 3.1, a: 0.07 },
      { x: 0.26, y: 0.88, c: '139,124,246', r: 0.52, ax: 0.05, ay: 0.06, sx: 0.015, sy: 0.021, ph: 4.6, a: 0.07 },
      { x: 0.50, y: 0.46, c: '52,211,153',  r: 0.44, ax: 0.08, ay: 0.05, sx: 0.013, sy: 0.019, ph: 2.3, a: 0.05 },
    ]
