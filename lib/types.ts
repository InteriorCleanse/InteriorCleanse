...
export type Book = { slug:string; title:string; subtitle?:string; track:'mind'|'health'|'home'; coverImage:string; imageAlt:string; hook:string; bullets:string[]; paperbackUrl:string; kindleUrl:string; featured:boolean }
